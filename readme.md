...
1. Follow the file format as provided. If you want to add more files, you can, but put those in respective folders.
2. File structure is provided. Some references are also given for completing the page.
